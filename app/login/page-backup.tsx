'useimport { useAppDispatch, useAppSelector } from '@/lib/redux/hooks';import { useState, useEffect } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
import { useAppDispatch, useA            {/* Get Started Button */}
            <div>
              <button
                type="button"
...
export default function LoginPage() {
  ...
  return (
    <BatikBackground className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
          ...
          <div style={{ gap: '10px', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="text-center" style={{ marginBottom: '32px' }}>
              <h1 style={{ 
                ...
                Apa kabar, let's get you a <span style={{ color: '#4A90E2' }}>job</span>
              </h1>
            </div>
        ...
        {/* POWERED BY RAPIDSCREEN - Bottom Left */}
